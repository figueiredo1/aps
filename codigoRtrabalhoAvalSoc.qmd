...
```{r}
# Ver se algum município de dt_eleicoes não está em dt_municípios (por erro de escrita)
...
dt <- merge(dt_eleicoes, dt_municipios, all.x = T)
...
dt2 <- dt[CJ(id_municipio, tipo_de_emenda),
         on = "id_municipio",
         allow.cartesian = TRUE]
## Agora sim, juntar as bases de dados
dt3 <- merge(dt2, dt_emendas,
