...
\subsection{3.2) Plotar gráfico}\label{plotar-gruxe1fico}
...
\includegraphics{estimacao_principal_brasil_20251124_files/figure-pdf/grafico_valor_empenhado_por_razao_votos_pp-1.pdf}

\subsection{3.3) Fazer estimação}\label{fazer-estimauxe7uxe3o}
...
\subsubsection{7.2.3) Plotar}\label{plotar}
...
\includegraphics{estimacao_principal_brasil_20251124_files/figure-pdf/grafico_valor_empenhado_por_razao_votos_pp_quad-1.pdf}

\subsubsection{7.2.3) Estimar}\label{estimar-1}
