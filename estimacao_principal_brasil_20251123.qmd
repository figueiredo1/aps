...
Vamos repetir as estatísticas e estimação para o modelo linear sem controles.
...
```{r}
#| label: grafico_barras_medias_caracteristicas_municipais_linear_sem_controles
...
### 7.1.2) Valor empenhado *per capita* de emendas parlamentares
...
## 7.2) Comparação entre tratados e controles

### 7.2.0) Obter janela ótima e filtrar bases de dados
...
### 7.2.1) Características municipais
...
### 7.2.2) Valores empenhados de emendas parlamentares
