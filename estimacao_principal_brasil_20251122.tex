...
\item
  ...
  votos do candidato a prefeito do PP
\end{itemize}
...
\CommentTok{\# Retirar municípios que tiveram eleições suplementares, identificados pela presença de mais de um candidato eleito na base}
...
\NormalTok{dt\_eleicoes }\OtherTok{\textless{}{-}}\NormalTok{ dt\_eleicoes[}\SpecialCharTok{!}\NormalTok{(id\_municipio }\SpecialCharTok{\%in\%}\NormalTok{ municipios\_com\_mais\_de\_um\_eleito)]}
...
\begin{verbatim}
Classes 'data.table' and 'data.frame':  1197 obs. of  7 variables:
...
\begin{verbatim}
Classes 'data.table' and 'data.frame':  1197 obs. of  13 variables:
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt\_todas[pop }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(pop, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ pop)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp)), }\AttributeTok{method =} \StringTok{"loess"}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{""}\NormalTok{,}
       ...
       \AttributeTok{x =} \StringTok{"Razão de votos do PP }\SpecialCharTok{\textbackslash{}n}\StringTok{(considerando os 2 candidatos mais votados)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt\_todas[densidade\_demografica }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(densidade\_demografica, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ densidade\_demografica)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp)), }\AttributeTok{method =} \StringTok{"loess"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \FunctionTok{label\_number}\NormalTok{()) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt\_todas[PIBpc }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(PIBpc, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ PIBpc)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp)), }\AttributeTok{method =} \StringTok{"loess"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \FunctionTok{label\_number}\NormalTok{()) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_caracteristicas_municipais_por_razao_votos_pp-3.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt\_todas[taxa\_escolarizacao }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(taxa\_escolarizacao, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ taxa\_escolarizacao)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp)), }\AttributeTok{method =} \StringTok{"loess"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \FunctionTok{label\_number}\NormalTok{()) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_caracteristicas_municipais_por_razao_votos_pp-4.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{dt\_todas[valor\_empenhado\_ipca\_pc }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(valor\_empenhado\_ipca\_pc, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ valor\_empenhado\_ipca\_pc)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{group =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp)), }\AttributeTok{method =} \StringTok{"loess"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \FunctionTok{label\_number}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{""}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Valor empenhado per capita {-} Todas as EPs"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"Razão de votos do PP }\SpecialCharTok{\textbackslash{}n}\StringTok{(considerando os 2 candidatos mais votados)"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Criar dt com média por grupo}
...
\NormalTok{media\_empenho\_individuais }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{theme\_minimal}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Comparação de médias de valor empenhado per capita municipal"}\NormalTok{,}
       \AttributeTok{caption =} \StringTok{"Fontes dos dados: TSE (2021), SIGA Brasil (2021)"}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"EPs individuais"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"Prefeito do PP?"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_barras_medias_emendas_parlamentares-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{rm}\NormalTok{(media\_empenho\_individuais)}
\end{Highlighting}
\end{Shaded}

\begin{itemize}
\item
  Note que aquelas poucas emendas de bancada distorcem bastante a média
  do valor empenhado por todas as emendas.
\item
  Note que não faz sentido olhar para medianas porque seriam
  simplesmente 0 para os dois grupos.
\end{itemize}
...
\NormalTok{  ),}
  \AttributeTok{statistic =} \ConstantTok{NULL}\NormalTok{, }\AttributeTok{stars =}\NormalTok{ T, }\AttributeTok{gof\_omit =} \StringTok{"R2|AIC|BIC|RMSE"}\NormalTok{,}
