...
\FunctionTok{options}\NormalTok{(}\AttributeTok{modelsummary\_latex =} \StringTok{"CMU Serif"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{g\_pop }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[pop }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(pop, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ pop, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  ...
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_family =} \StringTok{"CMU Serif"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{guides}\NormalTok{(}\AttributeTok{color =} \StringTok{"none"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{""}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"População"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"Razão de votos do PP"}\NormalTok{)}
...
\NormalTok{g\_densidade\_demografica }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[densidade\_demografica }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(densidade\_demografica, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ densidade\_demografica, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =}\NormalTok{ F) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"Dark2"}\NormalTok{, }\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{g\_PIBpc }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[PIBpc }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(PIBpc, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ PIBpc, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =}\NormalTok{ F) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"Dark2"}\NormalTok{, }\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{g\_taxa\_escolarizacao }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[taxa\_escolarizacao }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(taxa\_escolarizacao, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ taxa\_escolarizacao, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{se =}\NormalTok{ F) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"Dark2"}\NormalTok{, }\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_caracteristicas_municipais_por_razao_votos_pp-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Quadrático}
\NormalTok{g\_pop }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[pop }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(pop, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ pop, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{, }\AttributeTok{size =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_caracteristicas_municipais_por_razao_votos_pp-2.pdf}

\subsubsection{\texorpdfstring{2.2.1) Valor empenhado \emph{per capita}
de emendas
parlamentares}{2.2.1) Valor empenhado per capita de emendas parlamentares}}\label{valor-empenhado-per-capita-de-emendas-parlamentares}
...
\NormalTok{dt\_individuais[valor\_empenhado\_ipca\_pc }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(valor\_empenhado\_ipca\_pc, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ valor\_empenhado\_ipca\_pc, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_valor_empenhado_por_razao_votos_pp-1.pdf}
...
\NormalTok{dt\_individuais[valor\_empenhado\_ipca\_pc }\SpecialCharTok{\%between\%} \FunctionTok{quantile}\NormalTok{(valor\_empenhado\_ipca\_pc, }\FunctionTok{c}\NormalTok{(.}\DecValTok{02}\NormalTok{, .}\DecValTok{99}\NormalTok{), }\AttributeTok{na.rm =} \ConstantTok{TRUE}\NormalTok{)] }\SpecialCharTok{\%\textgreater{}\%}
  \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ votos\_razao\_pp, }\AttributeTok{y =}\NormalTok{ valor\_empenhado\_ipca\_pc, }\AttributeTok{color =} \FunctionTok{as.factor}\NormalTok{(vitoria\_pp))) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\AttributeTok{shape =} \DecValTok{21}\NormalTok{, }\AttributeTok{color =} \StringTok{"black"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{stat\_smooth}\NormalTok{(}\AttributeTok{method =} \StringTok{"lm"}\NormalTok{, }\AttributeTok{formula =}\NormalTok{ y }\SpecialCharTok{\textasciitilde{}} \FunctionTok{poly}\NormalTok{(x, }\DecValTok{2}\NormalTok{), }\AttributeTok{se =}\NormalTok{ F) }\SpecialCharTok{+}
  \FunctionTok{scale\_color\_brewer}\NormalTok{(}\AttributeTok{palette =} \StringTok{"Dark2"}\NormalTok{, }\AttributeTok{direction =} \SpecialCharTok{{-}}\DecValTok{1}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_vline}\NormalTok{(}\AttributeTok{xintercept =} \FloatTok{0.5}\NormalTok{, }\AttributeTok{linetype =} \StringTok{"dashed"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{scale\_y\_continuous}\NormalTok{(}\AttributeTok{labels =} \FunctionTok{label\_number}\NormalTok{()) }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_family =} \StringTok{"CMU Serif"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{guides}\NormalTok{(}\AttributeTok{color =} \StringTok{"none"}\NormalTok{) }\SpecialCharTok{+}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_valor_empenhado_por_razao_votos_pp-2.pdf}

\subsection{2.2) Comparação entre tratados e
controles}\label{comparauxe7uxe3o-entre-tratados-e-controles}

\subsubsection{2.2.0) Filtrar bases de
dados}\label{filtrar-bases-de-dados}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Filtrar bases de dados para municípios em que a margem de vitória foi de 5\% ou menos}
\NormalTok{dt\_todas }\OtherTok{\textless{}{-}}\NormalTok{ dt\_todas[votos\_razao\_pp }\SpecialCharTok{\textgreater{}=} \FloatTok{0.45} \SpecialCharTok{\&}\NormalTok{ votos\_razao\_pp }\SpecialCharTok{\textless{}=} \FloatTok{0.55}\NormalTok{]}
\NormalTok{dt\_individuais }\OtherTok{\textless{}{-}}\NormalTok{ dt\_individuais[votos\_razao\_pp }\SpecialCharTok{\textgreater{}=} \FloatTok{0.45} \SpecialCharTok{\&}\NormalTok{ votos\_razao\_pp }\SpecialCharTok{\textless{}=} \FloatTok{0.55}\NormalTok{]}
\NormalTok{dt\_bancada }\OtherTok{\textless{}{-}}\NormalTok{ dt\_bancada[votos\_razao\_pp }\SpecialCharTok{\textgreater{}=} \FloatTok{0.45} \SpecialCharTok{\&}\NormalTok{ votos\_razao\_pp }\SpecialCharTok{\textless{}=} \FloatTok{0.55}\NormalTok{]}
\NormalTok{dt\_relator }\OtherTok{\textless{}{-}}\NormalTok{ dt\_relator[votos\_razao\_pp }\SpecialCharTok{\textgreater{}=} \FloatTok{0.45} \SpecialCharTok{\&}\NormalTok{ votos\_razao\_pp }\SpecialCharTok{\textless{}=} \FloatTok{0.55}\NormalTok{]}
...
\begin{verbatim}
Quantidade de municípios com eleições acirradas: 483
Quantidade de municípios com eleições acirradas que receberam emendas: 39
Quantidade de municípios com eleições acirradas que receberam emendas individuais: 36
Quantidade de municípios com eleições acirradas que receberam emendas de bancada: 5
...
\NormalTok{titulo }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  ...
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_family =} \StringTok{"CMU Serif"}\NormalTok{)}
...
\NormalTok{g2 }\OtherTok{\textless{}{-}}\NormalTok{ medias\_municipios\_eleicoes }\SpecialCharTok{\%\textgreater{}\%}
  ...
  \FunctionTok{geom\_col}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{theme\_minimal}\NormalTok{(}\AttributeTok{base\_family =} \StringTok{"CMU Serif"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{""}\NormalTok{,}
       \AttributeTok{y =} \StringTok{"Densidade}\SpecialCharTok{\textbackslash{}n}\StringTok{demográfica"}\NormalTok{,}
       \AttributeTok{x =} \StringTok{"Prefeito do PP?"}\NormalTok{)}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_barras_medias_caracteristicas_municipais-1.pdf}
...
\includegraphics{estimacao_principal_brasil_20251122_files/figure-pdf/grafico_barras_medianas_caracteristicas_municipais-1.pdf}
...
\CommentTok{\# Duas regressões quadráticas sem controles de município}
...
\DocumentationTok{\#\# Completo}
\NormalTok{nomes\_variaveis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  \StringTok{"votos\_razao\_pp\_centr\_sq"} \OtherTok{=} \StringTok{"Razão de votos do PP ao quadrado"}\NormalTok{,}
  \StringTok{"votos\_razao\_pp\_centr"} \OtherTok{=} \StringTok{"Razão de votos do PP"}\NormalTok{,}
  \StringTok{"vitoria\_pp"} \OtherTok{=} \StringTok{"Prefeito do PP"}
\NormalTok{)}
\NormalTok{linhas\_adicionais }\OtherTok{\textless{}{-}} \FunctionTok{tribble}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{variavel, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear\_controles, }\SpecialCharTok{\textasciitilde{}}\NormalTok{quad, }\SpecialCharTok{\textasciitilde{}}\NormalTok{quad\_controles,}
                  \StringTok{\textquotesingle{}Forma funcional\textquotesingle{}}\NormalTok{, }\StringTok{"Linear"}\NormalTok{, }\StringTok{"Linear"}\NormalTok{, }\StringTok{"Quadrática"}\NormalTok{, }\StringTok{"Quadrática"}\NormalTok{,}
                  \StringTok{\textquotesingle{}Controles municipais\textquotesingle{}}\NormalTok{, }\StringTok{"Não"}\NormalTok{, }\StringTok{"Sim"}\NormalTok{, }\StringTok{"Não"}\NormalTok{, }\StringTok{"Sim"}\NormalTok{)}
\FunctionTok{modelsummary}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    ...
    \StringTok{"Quadrático sem controles"} \OtherTok{=}\NormalTok{ regs\_flexiveis,}
    \StringTok{"Quadrático com controles"} \OtherTok{=}\NormalTok{ regs\_flexiveis\_controles}
\NormalTok{  ),}
  ...
  \AttributeTok{coef\_omit =} \DecValTok{5}\SpecialCharTok{:}\DecValTok{12}\NormalTok{,}
  \AttributeTok{add\_rows =}\NormalTok{ linhas\_adicionais,}
  \AttributeTok{output =} \StringTok{"Resultados/ValorEmpenhadoPerCapitaIndividuaisFinal.png"}
\NormalTok{)}
...
\NormalTok{nomes\_variaveis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  ...
  \StringTok{"vitoria\_pp"} \OtherTok{=} \StringTok{"Prefeito do PP"}
\NormalTok{)}
\NormalTok{linhas\_adicionais }\OtherTok{\textless{}{-}} \FunctionTok{tribble}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{variavel, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear\_controles,}
                  \StringTok{\textquotesingle{}Forma funcional\textquotesingle{}}\NormalTok{, }\StringTok{"Linear"}\NormalTok{, }\StringTok{"Linear"}\NormalTok{,}
                  \StringTok{\textquotesingle{}Controles municipais\textquotesingle{}}\NormalTok{, }\StringTok{"Não"}\NormalTok{, }\StringTok{"Sim"}\NormalTok{)}
\FunctionTok{modelsummary}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    \StringTok{"Linear sem controles"} \OtherTok{=}\NormalTok{ regs\_lineares,}
    \StringTok{"Linear com controles"} \OtherTok{=}\NormalTok{ regs\_lineares\_controles}
\NormalTok{  ),}
  ...
  \AttributeTok{coef\_omit =} \DecValTok{5}\SpecialCharTok{:}\DecValTok{12}\NormalTok{,}
  \AttributeTok{add\_rows =}\NormalTok{ linhas\_adicionais,}
  \AttributeTok{output =} \StringTok{"Resultados/ValorEmpenhadoPerCapitaIndividuaisLinear.png"}
\NormalTok{)}

\DocumentationTok{\#\# Quadrático}
\NormalTok{nomes\_variaveis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  \StringTok{"votos\_razao\_pp\_centr\_sq"} \OtherTok{=} \StringTok{"Razão de votos do PP ao quadrado"}\NormalTok{,}
  \StringTok{"votos\_razao\_pp\_centr"} \OtherTok{=} \StringTok{"Razão de votos do PP"}\NormalTok{,}
  \StringTok{"vitoria\_pp"} \OtherTok{=} \StringTok{"Prefeito do PP"}
\NormalTok{)}
\NormalTok{linhas\_adicionais }\OtherTok{\textless{}{-}} \FunctionTok{tribble}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{variavel, }\SpecialCharTok{\textasciitilde{}}\NormalTok{quad, }\SpecialCharTok{\textasciitilde{}}\NormalTok{quad\_controles,}
                  \StringTok{\textquotesingle{}Forma funcional\textquotesingle{}}\NormalTok{, }\StringTok{"Quadrática"}\NormalTok{, }\StringTok{"Quadrática"}\NormalTok{,}
                  \StringTok{\textquotesingle{}Controles municipais\textquotesingle{}}\NormalTok{, }\StringTok{"Não"}\NormalTok{, }\StringTok{"Sim"}\NormalTok{)}
\FunctionTok{modelsummary}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
    \StringTok{"Quadrático sem controles"} \OtherTok{=}\NormalTok{ regs\_flexiveis,}
    \StringTok{"Quadrático com controles"} \OtherTok{=}\NormalTok{ regs\_flexiveis\_controles}
\NormalTok{  ),}
  ...
  \AttributeTok{gof\_omit =} \StringTok{"R2|AIC|BIC|RMSE"}\NormalTok{,}
  \AttributeTok{coef\_rename =}\NormalTok{ nomes\_variaveis,}
  \AttributeTok{coef\_omit =} \DecValTok{7}\SpecialCharTok{:}\DecValTok{14}\NormalTok{,}
  \AttributeTok{add\_rows =}\NormalTok{ linhas\_adicionais,}
  \AttributeTok{output =} \StringTok{"Resultados/ValorEmpenhadoPerCapitaIndividuaisQuad.png"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
Vamos repetir a estimação por região, mas precisamos prestar atenção no
número de observações e de tratados.
