...
setnames(dt_emendas, "", "id_municipio_nome")

# Retirar colunas utilizadas somente para filtros
dt_emendas <- dt_emendas[, .(NOMES DAS COLUNAS)]
...
-   Note que, após filtrar para 2021, restaram somente emendas individuais, de bancada e de comissão.
