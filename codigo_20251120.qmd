...
## 1.4) Juntar bases de municípios e eleições
...
## 1.5) Juntar base de municípios e eleições com bases de emendas

### 1.5.1) Para emendas de tipo X

### 1.5.1) Para emendas de tipo Y

### 1.5.1) Para emendas de tipo Z
...
Para cada análise (todas as emendas vs. emendas individuais vs. emendas de comissão vs. emendas de relator), vamos juntar as bases de dados (dt_municipios_eleicoes e dt_emendas) e, então, visualizar e estimar o valor adicional recebido via emendas parlamentares pelos municípios em que o candidato a prefeito do PP ganhou por pouco.

-   ACHO QUE NÃO VAI PRECISAR DO PROCEDIMENTO ABAIXO. SE NÃO, DELETAR

```{r}
# Compatibilizar nomes dos municípios de dt_emendas com os de dt_municipios_eleicoes

## Em dt_emendas, remover tudo que vem depois de " - " (geralmente são as siglas das UFs - checar com grepl)

## Em dt_municipios_eleicoes, retirar acentos e afins e passar tudo para maiúsculas (com clear_names)

## Verificar municípios sem match nas emendas parlamentares entre as bases de dados (só olhar pros 195 de dt_municipios_emendas!)

## Em dt_emendas, mudar ortografias divergentes de dt_municipios_eleicoes
```

## 3.1) Para emendas individuais
