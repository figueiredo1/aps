...
# 
# # Salvar base de dados resultante
# saveRDS(de_para_emendas_municipios, "Bases de dados/BD_id_emenda_municipio.rds")

# Carregar base de dados que relaciona emendas e municípios (por código do IBGE)
de_para_emendas_municipios <- readRDS("Bases de dados/BD_id_emenda_municipio.rds")
```
...
dt_emendas <- read_excel("Bases de dados/SigaBrasil_emendas.xlsx")
setDT(dt_emendas)
...
```{r}
# Plotar diferença em valores empenhados pelo prefeito
plot_grid(
ggplot() + 
