...
-   Note que nenhum município com eleições acirradas recebeu emendas de relator e somente 5 receberam emendas de bancada, então vamos analisar somente emendas individuais.
...
media_empenho_individuais %>%
  ...
  theme_minimal() +
  labs(title = "Comparação de médias de valor empenhado per capita municipal",
       caption = "Fontes dos dados: TSE (2021), SIGA Brasil (2021)",
       y = "EPs individuais",
       x = "Prefeito do PP?")
rm(media_empenho_individuais)
```
