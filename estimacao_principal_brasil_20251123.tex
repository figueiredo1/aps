...
\item
  ...
  coloquei as análises quadráticas como teste de robustez

  \begin{itemize}
  \tightlist
  \item
    Note que a janela ótima de modelos lineares e de modelos quadráticos
    são diferentes!
  \end{itemize}
\end{itemize}
...
\CommentTok{\# Obter janela ótima}
\DocumentationTok{\#\# Para modelo linear}
...
\section{6) Teste de robustez: Modelo
...
\subsubsection{6.1.1) Características
...
\subsubsection{\texorpdfstring{6.1.2) Valor empenhado \emph{per capita}
de emendas
parlamentares}{6.1.2) Valor empenhado per capita de emendas parlamentares}}\label{valor-empenhado-per-capita-de-emendas-parlamentares-1}
...
\CommentTok{\# Resultados {-} Quadrático}
\NormalTok{nomes\_variaveis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  \StringTok{"votos\_razao\_pp\_centr"} \OtherTok{=} \StringTok{"Margem de vitória do PP"}\NormalTok{,}
  \StringTok{"vitoria\_pp"} \OtherTok{=} \StringTok{"Prefeito do PP"}
\NormalTok{)}
\NormalTok{linhas\_adicionais }\OtherTok{\textless{}{-}} \FunctionTok{tribble}\NormalTok{(}\SpecialCharTok{\textasciitilde{}}\NormalTok{variavel, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear, }\SpecialCharTok{\textasciitilde{}}\NormalTok{linear\_controles,}
                  \StringTok{\textquotesingle{}Forma funcional\textquotesingle{}}\NormalTok{, }\StringTok{"Quadrático"}\NormalTok{, }\StringTok{"Quadrático"}\NormalTok{,}
                  \StringTok{\textquotesingle{}Controles municipais\textquotesingle{}}\NormalTok{, }\StringTok{"Não"}\NormalTok{, }\StringTok{"Sim"}\NormalTok{)}
\FunctionTok{modelsummary}\NormalTok{(}\FunctionTok{list}\NormalTok{(}
...
\NormalTok{  ),}
  ...
  \AttributeTok{coef\_omit =} \DecValTok{5}\SpecialCharTok{:}\DecValTok{12}\NormalTok{,}
  \AttributeTok{add\_rows =}\NormalTok{ linhas\_adicionais,}
  \AttributeTok{output =} \StringTok{"Resultados/ValorEmpenhadoPerCapitaIndividuaisQuadratico.png"}
\NormalTok{)}
\end{Highlighting}
\end{Shaded}
