...
\begin{verbatim}
Quantidade de municípios com eleições acirradas: 864
Quantidade de municípios com eleições acirradas que receberam emendas: 75
Quantidade de municípios com eleições acirradas que receberam emendas individuais: 69
Quantidade de municípios com eleições acirradas que receberam emendas de bancada: 10
Quantidade de municípios com eleições acirradas que receberam emendas de relator: 0
\end{verbatim}
...
\NormalTok{nomes\_variaveis }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  ...
  \StringTok{"vitoria\_pp"} \OtherTok{=} \StringTok{"Prefeito do PP"}\NormalTok{,}
  \StringTok{"Num.Obs."} \OtherTok{=} \StringTok{"N"}
\NormalTok{)}
